...
#RUN pip3 install tensorflow-gpu==${TENSORFLOW_VERSION} keras h5py awscli
#
...
#ARG CACHEBUST=1
#
#RUN mkdir -p /tensorpack
#COPY resources/tensorpack-live.zip /tensorpack/tensorpack-live.zip
#RUN cd /tensorpack && unzip -q /tensorpack/tensorpack-live.zip
#RUN mv /tensorpack /tensorpack-aws-argo
#RUN pip3 install --ignore-installed -e /tensorpack-aws-argo/
